...
/* Animasi background dari kiri ke kanan */
.gallery-box::before {
    content: '';
    position: absolute;
    left: 0;
...
/* Saat hover, background hijau muncul dari kiri ke kanan */
.gallery-box:hover::before {
    width: 100%;
}

/* Pastikan semua isi berada di atas layer animasi */
.gallery-box * {
    position: relative;
    z-index: 1;
...
/* Ubah teks dan icon menjadi putih saat hover */
.gallery-box:hover,
.gallery-box:hover * {
            ...
            <div class="px-4 py-3 card-body">
                <div class="row align-items-center">
                    <div class="col-9 p-3">
                        ...
                        <button class="capitalize btn btn-sm waves-effect waves-light btn-primary fs-6 py-2 px-4">  Take Practice</button>
                    </div>
                    <div class="col-3">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row gallery-wrapper" style="position: relative; height: 1087.5px;">
                    <div class="element-item col-xxl-3 col-xl-3 col-sm-6 listening border-0" data-category="listening" style="position: absolute; left: 0px; top: 0px;">
